...
// 	}
// 	roomID, err := service.CreateRoom(ctx, &createRoomParams)
// 	require.NoError(t, err)
// 	assert.NotEmpty(t, roomID, "room id")

// 	connectMember1Params := room.ConnectMemberParams{
// 		Conn:     &websocket.Conn{},
// 		MemberID: roomID.MemberID,
// 	}
...
// 	assert.Equal(t, addVideoResp.AddedVideo.AddedByID, roomID.MemberID, "added by id is not equal")
// 	t.Log("video added")
...
// 	assert.Equal(t, disconnectMemberResp.Memberlist[0].ID, roomID.MemberID, "member id is not equal")
